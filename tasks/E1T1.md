# E1T1 — /reserve command and date selection

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement /reserve command with calendar widget for date selection (within lookahead window). Write dialog spec to tests/specs/E1T1.json and append to tests/commands.json.
