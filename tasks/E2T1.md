# E2T1 — /bookings_today command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement /bookings_today command to list today's bookings with inline actions (Mark no-show, Cancel). Write dialog spec to tests/specs/E2T1.json and append to tests/commands.json.
