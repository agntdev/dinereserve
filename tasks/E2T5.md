# E2T5 — /export YYYY-MM-DD command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement /export command to generate CSV of bookings for specified date range and send as Telegram file. Write dialog spec to tests/specs/E2T5.json and append to tests/commands.json.
