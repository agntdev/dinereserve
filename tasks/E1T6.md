# E1T6 — Handle /reserve command to initiate booking flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement command handler for /reserve that:
1. Validates user input
2. Displays date selection interface
3. Transitions to party size selection
4. Ensures proper error handling and flow continuation
Depends on T01 (command scaffold) and E1T2 (date selection)

## Skills

**Skills:** telegram-bot-basics, command-handling
