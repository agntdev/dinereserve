# E2T4 — /config command and interactive editor

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement /config command for editing opening hours, table setup, and other config parameters. Write dialog spec to tests/specs/E2T4.json and append to tests/commands.json.
