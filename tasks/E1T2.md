# E1T2 — Party size input and availability calculation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement party size selection (quick buttons + numeric fallback) and availability calculation for selected date. Write dialog spec to tests/specs/E1T2.json and append to tests/commands.json.
