# E1T5 — Reschedule and Cancel inline buttons

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Add Reschedule and Cancel buttons to confirmation message. Implement reschedule flow (repeats availability check). Write dialog spec to tests/specs/E1T5.json and append to tests/commands.json.
