# E2T2 — /bookings YYYY-MM-DD command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement /bookings command with date parameter for paginated booking listings. Write dialog spec to tests/specs/E2T2.json and append to tests/commands.json.
