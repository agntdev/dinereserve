# E2T3 — /capacity_today command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement /capacity_today command to show opening hours, sitting length, and seat availability per time block. Write dialog spec to tests/specs/E2T3.json and append to tests/commands.json.
