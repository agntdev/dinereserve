# E1T4 — Booking confirmation and reference code

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Collect guest name/phone (optional), confirm booking, generate 6-char ref code. Write dialog spec to tests/specs/E1T4.json and append to tests/commands.json.
