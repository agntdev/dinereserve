# E5T1 — Guest reminder system

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement configurable reminders (default 120min before booking). Write dialog spec to tests/specs/E5T1.json and append to tests/commands.json.
