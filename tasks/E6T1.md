# E6T1 — Admin registration and setup flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DRSV

Implement first-run flow to register admin Telegram IDs and configure initial settings (timezone, opening hours, tables, etc.). Write dialog spec to tests/specs/E6T1.json and append to tests/commands.json.
